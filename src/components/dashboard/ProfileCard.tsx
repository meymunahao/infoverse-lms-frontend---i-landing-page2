...
export default function ProfileCard() {
  ...
  return (
    <Link href="/profile">
      <div className="bg-gradient-to-br from-[#BDD0D2] to-[#A8BFC1] rounded-[20px] p-6 w-[330px] shadow-lg hover:shadow-xl transition-all hover:scale-105 cursor-pointer">
